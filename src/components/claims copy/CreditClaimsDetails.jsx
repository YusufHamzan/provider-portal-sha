...
import CreditClaimsBasicComponent from "./credit.claim.basic.component";
import CreditClaimsTimelineComponent from "./credit.claim.timline.component";
import CreditClaimsDocumentComponent from "./credit.claim.doc.component";
...
export default function CreditClaimsDetails(props) {
...
console.log("asdfghjkl")
  ...
  const handleSearch = (membershipNo) => {
    preauthService
      .getPreAuthsByMembership(membershipNo || enteredMembershipNo)
      .subscribe((res) => {
    ...
    <>
      ...
      >
        <Alert variant="filled" severity="error">
          Please provide the Pre-Auth ID for claims that are currently in the
      ...
      <div>
        ...
        {!id && importMode ? (
          <Paper
            elevation="none"
            className={classes.prospectImportOuterContainer}
          >
            {/* <Snackbar
              open={idErrorMsg}
              autoHideDuration={6000}
              onClose={handleIDErrorClose}
            >
        ...
        >
          <Box sx={style}>
            <Typography
              ...
              align="center"
            >
              No PreAuth found for given id. You can still create Claim
              Reimbursement.
            </Typography>
            <Typography
